...
inline constexpr float CHECK_TRACKER_MAP_TOOLTIP_MIN_CONTENT_WIDTH = 220.0f;
inline constexpr float CHECK_TRACKER_MAP_TOOLTIP_LOGIC_MIN_CONTENT_WIDTH = 700.0f;
inline constexpr float CHECK_TRACKER_MAP_TOOLTIP_MAX_VIEWPORT_WIDTH_RATIO = 0.6f;
